...
* **Strava Account:** You will need to create a Strava API Application. (If the link throws an error, try opening it on incognito, or type manually): https://www.strava.com/settings/api
