...
Below is a chart which Claude made for me to show me my mileage
![Ameya's Week-On-Week Mileage](ameya_weekly_mileage.png)
...
3. Website: It can be anything (e.g., http://localhost)
4. **Crucial:** Set the "Authorization Callback Domain" to `localhost`.
