...
* **Strava Account:** You will need to create a Strava API Application.
   1. First, log in to Strava: https://www.strava.com/login
   2. Then, visit the API settings: https://www.strava.com/settings/api
